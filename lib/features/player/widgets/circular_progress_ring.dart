...
class CircularProgressRing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final activeProgressColor = progressColor ?? theme.colorScheme.primary;
    final activeBackgroundColor = backgroundColor ?? theme.colorScheme.onSurface.withOpacity(0.1);
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: activeProgressColor, // Thumb follows progress color
                      shape: BoxShape.circle,
                      boxShadow: [
                        BoxShadow(
                          color: (theme.brightness == Brightness.light ? Colors.black12 : Colors.black45),
                          blurRadius: 4,
