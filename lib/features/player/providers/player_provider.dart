...
class PlayerNotifier extends StateNotifier<void> {
  ...
  Future<void> playLibrarySong(SongModel song, List<SongModel> fullList) async {
    final mediaItems = fullList.map(_toMediaItem).toList();
  ...
  Future<void> toggleShuffle() async {
    ...
    await audioHandler.setShuffleMode(isShuffleOn ? AudioServiceShuffleMode.none : AudioServiceShuffleMode.all);
  }
