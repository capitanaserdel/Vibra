  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.settings_rounded, color: Theme.of(context).colorScheme.onBackground.withOpacity(0.7)),
        ...
        return ListTile(
          leading: station.favicon.isNotEmpty
              ...
              : Container(
                  ...
                  child: Icon(Icons.radio_rounded, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.4)),
                ),
          title: Text(station.name, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Theme.of(context).colorScheme.onSurface)),
          subtitle: Text(station.tags, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.5))),
          onTap: () {
